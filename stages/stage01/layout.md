...
|---|---|---|---|---|
| W1 | S1 | x ≥ 800 | lv01 ×2 | チュートリアル相当。倒したら次へ |
| W2 | S2 | x ≥ 1600 | lv01 ×3 + lv03 ×1 | 数の圧。lv03 は既存 AI を使い回す |
| W3 | S2 | x ≥ 2500 | lv01 ×2 + lv05 ×1 | 中型混じり。lv05 が実装済みなら使う |
| W4 | S3 | x ≥ 3400 | lv01 ×2 + lv06 ×1 | 最終。lv06 のきりもみ即死を見せ場に。**全滅で STAGE CLEAR** |

※ lv03/lv05/lv06 は既存 lv01 のパラメータ差替えで代用してよい（敵 AI 拡張は Phase 3 本流の zealous-hertz 側マター）。
