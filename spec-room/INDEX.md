...
| [簡易必殺技ボタン（K キー / スマブラ式・最終形）](archive/simple-special-button.md) | 昇格済 | 2026-05-17 | §9.0（新設）攻撃 ID 命名規約 | 3 カテゴリ atk/add/sp + 修飾子で確定。コマンド入力廃止・K で簡易入力 |
| [コンボ広がりの設計：技数 vs 状況数](discussions/combo-depth-axis.md) | 検討中（設計指針） | 2026-05-15 | §4 / §9 / §17 | ベアナックル 4 観察から。技を増やす前に状況軸を増やす方針 |
| [壁やられシステム（衝突先別挙動）](archive/wall-yarare-system.md) | 昇格済（実装着手中） | 2026-05-15 | §9.4.1（新設） | 壁=張り付き / 敵=拡散連鎖 / 壊れ物=破壊。実装は壁→敵→壊れ物の順 |
| [相打ち演出（必殺技 × ボス攻撃）](discussions/mutual-hit-flavor.md) | アイデア記録 | 2026-05-16 | §9 / §11 / §17 | フレーバー演出。狙えない・たまに見える設計。実装は Phase 3 ボス戦と同時期 |
| [ゴア・スクラップシステム（仮）](discussions/gore-scrap-system.md) | 検討中（ほぼ確定・詳細詰め中） | 2026-05-16 | §9 / §11 / §17 | メカ部位破壊。黒シルエット + オイル飛沫。雑魚 / 中ボス / 大ボス で項目分け |
| └─ [ゴア・スクラップ 雑魚仕様（敵死亡実装 + 部位破壊）](discussions/gore-scrap-mob-prototype.md) | 検討中（敵死亡実装と同時着手・優先度高） | 2026-05-16 | §9 / §17 / 親トピック | 「敵を倒す」本実装そのもの。ゴア演出と一体設計が自然 |
| [テスタープレイ feedback 集約](discussions/testplay-feedback.md) | 検討中（受け入れ対応中） | 2026-05-17 | §9 / §22.5 / §11 | 速い・難しい / ダッシュ / 派生は弱に / 見た目。操作簡易化を最優先 |
