...
export const ATTACKS = {
  ...
  c01_sp_01_air: {
    ...
    multiHitVacuum: true,
    // 空中滞空：撃った反動で「少し沈んで → 軽く浮き上がる」ゆるい弧を描く。
    //   airStartVy で発射時に小さく下方初速 → airGravFactor を負（浮力）にして
    //   減速・反転 → ふわっと浮く。通常重力で落ちると敵を取りこぼし、
    //   ビタ止まりだと無機質なため、その中間の手触りに。
    airStartVy:    -3,     // 発射時の下方初速（少し沈む）
    airGravFactor: -0.22,  // 負＝浮力（沈んだ後ゆっくり浮き上がる）
    damagePerHit:   4,
